...
class hardwareConfiguration(object):
    ...
    channelDict = {
                   'channel_0':channelConfiguration(0, True, False, False, False),
                   'channel_1':channelConfiguration(1, True, False, False, False),
    ...
    ddsDict =   {
                'DDS_0':ddsConfiguration(        0,  (1.0,400.0),    (-63.0,-5.0),   70.0,   -33.0),
                'DDS_1':ddsConfiguration(    1,  (70.0,100.0),   (-63.0,-12.0),  90.0,   -53.0),
                }
    remoteChannels = {
                    }