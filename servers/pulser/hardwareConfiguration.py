...
class hardwareConfiguration(object):
    ...
    ddsDict =   {
                'DDS_0':ddsConfiguration(    0,  (0.1,800.0),   (-63.0,-3.0),  70.0,   -63.0),
                'DDS_1':ddsConfiguration(    1,  (0.1,800.0),   (-63.0,-3.0),  75.0,   -63.0),
                'DDS_2':ddsConfiguration(    2,  (0.1,800.0),   (-63.0,-3.0),  80.0,   -63.0),
                'DDS_3':ddsConfiguration(    3,  (0.1,800.0),   (-63.0,-3.0),  85.0,   -63.0),
                'DDS_4':ddsConfiguration(    4,  (0.1,800.0),   (-63.0,-3.0),  90.0,   -63.0),
                'DDS_5':ddsConfiguration(    5,  (0.1,800.0),   (-63.0,-3.0),  95.0,   -63.0),
                'DDS_6':ddsConfiguration(    6,  (0.1,800.0),   (-63.0,-3.0), 100.0,   -63.0),
                'DDS_7':ddsConfiguration(    7,  (0.1,800.0),   (-63.0,-3.0), 105.0,   -63.0),
                }
    remoteChannels = {
                    }